...
# # Fill data
# for i in range(1, 11):
#     sheet[f"A{i+1}"] = i      # Months
#     sheet[f"B{i+1}"] = i * 2  # Sales
#     sheet[f"C{i+1}"] = i      # Profits
...
# # Data includes header row (row 1)
# data = Reference(sheet, min_col=2, max_col=3, min_row=1, max_row=11)

# # Categories = months (skip header row)
# cats = Reference(sheet, min_col=1, min_row=2, max_row=11)

# chart.add_data(data, titles_from_data=True)
# chart.set_categories(cats)

# sheet.add_chart(chart, "E5")
# wb.save("BalancedChart.xlsx")
