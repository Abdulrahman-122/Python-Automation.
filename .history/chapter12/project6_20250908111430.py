...
cleaned1 = [item.strip() for item in lines1]
Up_lines1 = [item for item in cleaned1 if item != ""]

cleaned2 = [item.strip() for item in lines2]
Up_lines2 = [item for item in cleaned2 if item != ""]

for item in Up_lines1:
    sheet['A'+str(Up_lines1.index(item)+1)]=item
for item in Up_lines2:
    sheet['B'+str(Up_lines2.index(item)+1)]=item
