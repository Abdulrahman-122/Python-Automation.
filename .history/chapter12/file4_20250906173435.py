...
refobj=openpyxl.chartsheet.Reference(sheet,(1,1),(8,4))
series_Obj=openpyxl.chartsheet.series(refobj,title='Firstseries')
chart_obj=openpyxl.chartsheet.BarChart()
chart_obj.append(series_Obj)
sheet.add_chart(char)
