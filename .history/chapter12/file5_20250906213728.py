...
chart=ScatterChart()
chart.title='Sales scatter Months'
chart.x_axis.name='Months'
chart.y_axis.name='Sales'


y_values=Reference(sheet,min_col=2,min_row=1,max_row=9)
x_values=Reference(sheet,min_col=1,min_row=1,max_col=9)

series=Series(y_values,x_values,titles_from_chart=True)
