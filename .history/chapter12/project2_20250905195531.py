...
for rowobj in range(2, sh.max_row + 1):
    ...
    if produce_item in Updated_prices:
        sh.cell(row=rowobj, column=2).value = Updated_prices[produce_item]
wb.save("Update_produceSales2.xlsx")
print("Done operation.")

# you will notice that the second solution is better than the first as we didn't use 
#many if statements
#yeah it's clear
#
#
#
#Ideas for similar projec
#
#
#
#
