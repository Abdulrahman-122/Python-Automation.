...
print("Heighst column", sh1.max_column)


# in Excel sheet to convert Numbers into Letters:use get_column_letter
#or conver from letters to number : column_index_from_string

# import openpyxl
# from openpyxl.utils import get_column_letter, column_index_from_string

# print(get_column_letter(1))
# print(get_column_letter(700))
...
wb = openpyxl.load_workbook("duesRecords.xlsx")
sh1 = wb["Sheet1"]
print(get_column_letter(sh1.max_row))
print(get_column_letter(sh1.max_column))
print(column_index_from_string("A"))
print(column_index_from_string("AA"))
print(column_index_from_string("QQ"))
print(column_index_from_string('EE'))
max_column=sh1.max_column
letter_heighest_column=get_column_letter(max_column)
print(letter_heighest_column)
print(column_index_from_string(letter_heighest_column))
