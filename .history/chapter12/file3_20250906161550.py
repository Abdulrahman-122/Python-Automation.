...
# sheet.row_dimensions[1].height=200       #Adjust all rows with this dimension
...
sheet['B1']='Did you love me'
sheet['C1']='I accept your openion'
...
#as you see we define the size of row and column of the cells in excell
#so we use from row_dimensions ->height object
#and from column_dimensions -> width object
#note with the value for height from 0 to 409 
#where each value represent the height in points
#where each point 1/72 of inch
#with width-> value from 0 to 255 (where each value represent the number of character width into this column)
#
#the default row-height=12.75 point
#the default column-width=8.43 characters
#
#
#
#
