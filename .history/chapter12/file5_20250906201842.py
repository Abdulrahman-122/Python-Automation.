...
wb = openpyxl.load_workbook("Chart5.xlsx")
sheet = wb["Sheet"]

# Create scatter chart
chart = ScatterChart()
chart.title = "Sales Scatter Chart"
chart.x_axis.title = "Months"
chart.y_axis.title = "Sales"

# X values (Months) → column 1, starting from row 2
xvalues = Reference(sheet, min_col=1, min_row=2, max_row=sheet.max_row)

# Y values (Sales) → column 2, starting from row 2
